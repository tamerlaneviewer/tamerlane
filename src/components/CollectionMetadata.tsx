...
const CollectionMetadata = ({ collectionMetadata }) => {
  ...
  return (
    <div className="flex flex-col flex-grow h-full overflow-auto p-4 bg-white">
      ...
      {collectionMetadata.label && (
        <div className="mb-4">
          ...
          <p
            ...
            dangerouslySetInnerHTML={renderHTML(getValue(collectionMetadata.label))}
          />
        </div>
      )}

      {/* Metadata Section */}
      {collectionMetadata.metadata && collectionMetadata.metadata.length > 0 && (
        <div className="mb-4">
      ...
      {collectionMetadata.provider && collectionMetadata.provider.length > 0 && (
        <div className="mb-4">
