      ...
      <div className="flex border-b">
        <button
          className={`flex-1 py-2 text-center flex items-center justify-center gap-2 transition-all ${
            activeTab === "annotations" ? "bg-gray-300 font-bold text-black" : "bg-gray-200 text-gray-500"
          } hover:bg-gray-400`}
        ...
        <button
          className={`flex-1 py-2 text-center flex items-center justify-center gap-2 transition-all ${
            activeTab === "searchResults" ? "bg-gray-300 font-bold text-black" : "bg-gray-200 text-gray-500"
          } hover:bg-gray-400`}
